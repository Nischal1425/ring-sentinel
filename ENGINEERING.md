# Ring Sentinel — engineering notes

The working behind [README.md](README.md): how the graph is built, what each
signal is worth, the benchmark it loses, and the bugs found along the way.
